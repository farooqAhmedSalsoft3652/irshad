...
export const grammaticalGender = [
  {
    value: "",
    text: "Select Grammatical Gender",
  },
  {
    value: "masculine",
    text: "Masculine",
...
export const subcriptionTypeTwo = [
  {
    value: "",
    text: "All",
  },
...
export const quizLanguageOptions = [
  {
    value: "0",
