...
export const consultantScreeningData = {
  status: true,
  message: "Service Provider listing",
  detail: {
    current_page: 1,
    data: [
      {
        ...
        name: "Sarah",
        last_name: "Miles",
        registration_date: "2025-04-21T12:34:17.000000Z",
        // appointment_time: "06:00 PM",
        appointment_time: "2025-04-21T12:34:17.000000Z",
        category: "Education",
        gender: "Female",
        language: "English",
        nationality: "Qatar",
...
export const consultantAppointmentLogsData = {
  status: true,
  message: "subcription logs",
  detail: {
    current_page: 1,
    data: [
      {
        id: 1,
        appointment_iD: "#1234567",
        consultant_name: "Eric",
        appointment_type: "standard",
        booking_date: "2024-06-25T14:29:37.000000Z",
        appointment_date: "2024-07-25T14:29:37.000000Z",
        duration: "30 minutes",
...
export const consultantServiceAppointmentLogsData = {
  status: true,
  message: "subcription logs",
  detail: {
    current_page: 1,
    ...
    data: [
      {
        ...
        standard_call_min: "20",
        standard_call_max: "25",
        standard_video_min: "20",
        standard_video_max: "25",
        ...
        appointmentLogs: [
          {
            ...
            session_type: "chat",
            booking_date: "2024-06-25T14:29:37.000000Z",
            appointment_date: "2024-06-25T14:29:37.000000Z",
            duration: "30 minutes",
            charges: "$30",
            status: "Upcoming",
          },
...
export const ScreeningReportData = {
  status: true,
  message: "Service Provider listing",
  detail: {
    current_page: 1,
    data: [
      {
        ...
        name: "Sarah",
        last_name: "Miles",
        complete_date: "2025-04-21T12:34:17.000000Z",
        // appointment_time: "06:00 PM",
        appointment_time: "2025-04-21T12:34:17.000000Z",
        category: "Education",
        gender: "Female",
...
export const consultantRequestsData = {
  status: true,
  message: "Service Provider listing",
  detail: {
    current_page: 1,
...
export const consultantCategoryData = {
  status: true,
  message: "Service Provider listing",
  detail: {
    current_page: 1,
...
export const newRequestConsultantData = {
  status: true,
    ...
    data: [
      {
        ...
        state: "Texas",
        city: "Dallas",
        bio: "Dr. Tom has over 07 years of experience in the field of pediatrics. She has worked in several healthcare settings, including children's hospitals, clinics, and primary care facilities, providing specialized medical care for children of all ages.",
        education: [
          {
            id: 1,
            institute_name: "Institute ABC",
        ...
        questions: [
          {
            questionNo: 1,
            question: "Lorem Ipsum Dolor Sit Amet, Consectetur Adipis",
            options: {
              A: "Lorem Ipsum",
              B: "Lorem Ipsum",
              C: "Lorem Ipsum",
        ...
        adminComment: `Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit. Aenean Euismod Bibendum Laoreet. Proin Gravida Dolor Sit Amet Lacus Accumsan Et Viverra Justo Commodo. Proin Sodales Pulvinar Tempor.`,
        amountSet: {
          standard: {
            chat: "$10 - $20",
            call: "$20 - $25",
        ...
        givenSubCategory: ["Abc Service", "Xyz Service", "Afs Service"],
        givenServices: ["Abc Service", "Xyz Service", "Afs Service"],
      ...
      },
      {
        ...
        state: "New York",
        city: "New York City",
        bio: "Dr. Adam is a renowned cardiologist with 15 years of experience. He has made significant contributions in the field of cardiology and worked in various reputed hospitals to treat patients with cardiovascular diseases.",
        education: [
          {
            id: 1,
            institute_name: "Institute ABC",
...
export const reportsManagementData = {
  status: true,
  message: "Report logs",
  detail: {
    current_page: 1,
    data: [
      {
        ...
        appointmentDate: "10/01/2024",
        appointmentTime: "06:00 PM to 08:00 PM",
        sessionType: "Chat",
        category: "Education",
