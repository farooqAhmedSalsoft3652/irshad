...
import { subsPaymentValidationSchema,} from "../../../Config/Validations";
...
const SubscriptionPayment = ({ showModal }) => {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    showModal(
      ...
      () => navigate('/subscriptions/subscriptions-logs'),
      true 
    );
...
export default withModal(SubscriptionPayment);