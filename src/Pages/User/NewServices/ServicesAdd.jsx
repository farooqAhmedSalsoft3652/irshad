    ...
    <section className="page-content profile">
      <Container fluid>
        <Row>
          <Col
            sm={12}
            className="gap-3 d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3 mb-lg-4 mb-xl-5"
          >
                  ...
                  {({
                    ...
                    <Form onSubmit={handleSubmit}>
                      ...
                      <Row>
                        ...
                        {/* Online Charges */}
                        {(values.service_type === "online" ||
                          values.service_type === "both") && (
                          <Col xs={12} lg={6} xxl={6} className="mb-3">
                            <CustomInput
                              ...
                              onBlur={handleBlur}
                              error={
                                touched.online_charges && errors.online_charges
                              }
                            />
                          </Col>
                        )}
                        ...
                        {(values.service_type === "offline" ||
                          ...
                          <Col xs={12} lg={6} xxl={6} className="mb-3">
                            <CustomInput
                              ...
                              onBlur={handleBlur}
                              error={
                                touched.onsite_charges && errors.onsite_charges
                              }
                            />
                          </Col>
                        )}
                        ...
                        <Col
                          xs={12}
                          className="d-flex image-upload-style-2 mb-3"
                        >
                                  ...
                                  {values[`${day}Time`].map((_, index) => (
                                    ...
                                    >
                                      <CustomInput
                                        ...
                                        value={
                                          values[`${day}Time`][index].startTime
                                        }
                                        onChange={handleChange}
                                        onBlur={handleBlur}
                                        error={
