...
import { paymentCardValidationSchema,} from "../../../Config/Validations";
...
const ServiceProviderPayment = ({ showModal }) => {
  ...
  useEffect(() => {
    const getUser = async () => {
      const response = servicesData.detail.data.find((e) => e.id === Number(id));
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    showModal(
      "Successful",
      "Booking 123 has been done successfully.",
      () => navigate('/order-logs'),
      true 
    );
          ...
          <Row>
            ...
            <div className="form-card px-5">
                <div className="payment-amount text-center mb-5">
                  <h3 className="fw-semibold mb-4">Amount: <span>$30</span></h3>
                </div>
              <Formik
                initialValues={{
                  card_holder_name: "",
...
export default withModal(ServiceProviderPayment);