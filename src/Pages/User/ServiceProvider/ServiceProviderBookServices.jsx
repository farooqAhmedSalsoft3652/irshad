...
const ServiceProviderBookServices = ({filters, updatePagination}) => {
...
const handleSubmit = (values) => {
  ...
  navigate("/services-provider/book-services/view-booking", {
...
export default withFilters(ServiceProviderBookServices)
