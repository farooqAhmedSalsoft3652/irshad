...
import { accountTypeOptions, bankNameOptions } from "../../../Config/TableStatus";
          ...
          <Row>
            <Col sm={12} className="d-flex flex-wrap mb-3 mb-lg-4">
              ...
              <div className="mx-auto">
                ...
                <h4 className="page-title fw-medium">Minimum withdraw Amount: $20</h4>
              </div>
            </Col>
          </Row>
          <Row>
                      ...
                      {({ values, errors, touched, handleChange, handleBlur, handleSubmit, setFieldValue }) => (
                        <Form onSubmit={handleSubmit}>
                          <Row>
                            <Col xs={12}>
                              <Row>
                                <Col xs={12} lg={6} xxl={6} className="mb-lg-4 mb-3 position-relative">
                                  <div className="position-relative">
                                    ...
                                    onBlur={handleBlur}
                                    error={touched.fundAmount && errors.fundAmount}
                                  />
                                  <span className={`${touched.fundAmount && errors.fundAmount ? 'dollar_icon_with_error': 'dollar_icon'}`}><FaDollarSign /></span>
                                  </div>
                                </Col>
                                ...
                                <Col xs={12} lg={6} xxl={6} className="mb-lg-4 mb-3">
                                  <div className="select-inner-wrapper">
                                    <Select
                                      ...
                                      onChange={(e) => setFieldValue("bankName", e)}
                                      label="Bank Name"
                                      labelclass="mainLabel"
                                      onBlur={handleBlur}
                                      isInputNeeded={false}
                                ...
                                <Col xs={12} lg={6} xxl={6} className="mb-lg-4 mb-3">
                                  <CustomInput
                                    ...
                                    onChange={handleChange}
                                    onBlur={handleBlur}
                                    error={touched.confirmSwiftCode && errors.confirmSwiftCode}
                                  />
                                </Col>
                                <Col xs={12} lg={6} xxl={6} className="mb-lg-4 mb-3">
                                  <CustomInput
