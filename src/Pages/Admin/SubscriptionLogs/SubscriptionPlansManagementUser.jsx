...
const SubscriptionPlansManagementUser = ({ showModal, filters, setFilters, pagination, updatePagination }) => {
...
export default withModal(withFilters(SubscriptionPlansManagementUser));
