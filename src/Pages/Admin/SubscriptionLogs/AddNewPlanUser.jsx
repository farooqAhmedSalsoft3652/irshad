...
const AddNewPlanUser = ({ showModal }) => {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    console.log(values);
    startSubmitting();
    showModal("Successful", `New Plan has been created successfully!`, () => navigate(-1), true);
    stopSubmitting();
    resetForm();
  };
              ...
              <div className="row mb-3">
                <div className="col-xl-4 col-lg-6 col-md-8">
                  <Formik
                    ...
                    validationSchema={addNewSubscriptionPlanSchema}
...
export default withModal(AddNewPlanUser);
