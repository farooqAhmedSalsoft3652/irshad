...
const Chat = ({ showModal }) => {
  ...
  const PermissionToShare = () => {
    showModal(
      ``,
      `Permission Granted to user to share file successfully.`,
      null,
      true
    );
  };
      ...
      <Container fluid>
        <div className=" px-sm-0 px-1">
          <div className="site_card p-0 bg-white">
            <h2 className="text-center fw-bold pt-3 mb-3 page-title">Chat</h2>
            <div
                      ...
                      <div className="d-flex align-items-center flex-wrap gap-3 justify-content-between">
                        ...
                        <div className="d-flex align-items-center gap-3">
                          ...
                          >
                            ...
                            <Dropdown.Menu>
                              <Dropdown.Item
                                onClick={() => PermissionToShare()}
                              >
                                Give Permission To Share File
                              </Dropdown.Item>
                    ...
                    <div className={Styles.messages}>
                      <ScrollToBottom className={Styles.messages}>
                        {chatBox.map((message, index) => (
                          ...
                          >
                            <div
                              className={`flex-grow-1 ${Styles["message-column"]}`}
                            >
                            ...
                            <div
                              className={`flex-shrink-0 ${Styles["avatar-column"]}`}
                            >
                                ...
                                {(message?.picture ||
                                  ...
                                  <img
                                    ...
                                    onError={(e) => {
                                      ...
                                      e.target.src =
                                        images.UserImage || images.Placeholder;
                                    }}
                                  />
                                )}
                              </div>
