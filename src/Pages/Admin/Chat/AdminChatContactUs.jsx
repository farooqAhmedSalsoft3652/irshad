...
const AdminChatContactUs = ({ showModal }) => {
  ...
  usePageTitleUser("Chat Contact Us");
        ...
        <Container fluid>
          <div className="px-sm-0 px-1">
            <div className="site_card p-0 bg-white">
              <h2 className="text-center fw-bold pt-3 mb-3 page-title">Chat Contact Us</h2>
                          ...
                          <div className="d-flex align-items-center gap-3">
                            ...
                            <Dropdown className={`chatHeaderDropdown`} align={"end"}>
                              ...
                              <Dropdown.Menu>
                                ...
                                <Dropdown.Item onClick={() => BothRestricted()}>Restrict Message From User/Consultant</Dropdown.Item>
                              </Dropdown.Menu>
                            </Dropdown>
                          </div>
                        </div>
...
export default withModal(AdminChatContactUs);
