...
import { questionTableData } from "../../../Config/data";

const QueryQuestionDetails = () => {
  const { id } = useParams();
  const [queriesData, setQueriesData] = useState({});

  useEffect(() => {
    const getUser = async () => {
      const response = questionTableData.detail.data.find((e) => e.id === id);
...
export default QueryQuestionDetails;
