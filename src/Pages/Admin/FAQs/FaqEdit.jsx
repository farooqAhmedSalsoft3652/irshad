...
const FaqEdit = ({ showModal }) => {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    try {
      ...
      showModal("", `FAQ has been updated successfully`, () => navigate(-1), true);
      resetForm();
    } catch (error) {
                  ...
                  <Form className="category-wrap">
                      ...
                      <div className="row">
                        <div className="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                          <VideoUploader
                            ...
                            onPosterChange={(file) => setFieldValue("poster", file)}
                          />
                        </div>
                      </div>
                    )}
                    <div className="row">
                      <div className="col-12 mt-3">
                        <CustomButton variant="btn btn-primary min-width-180" text="Update" type="submit" />
                      </div>
                    </div>
                  </Form>
                )}
...
export default withModal(FaqEdit);
