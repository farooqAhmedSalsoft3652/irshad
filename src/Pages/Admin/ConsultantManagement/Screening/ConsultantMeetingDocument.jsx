...
import { setConsultantProfileSchema } from "../../../../Config/Validations";
import withModal from "../../../../HOC/withModal";

const ConsultantMeetingDocument = ({ showModal }) => {
  ...
  const handleSubmit = async (values, { resetForm, setSubmitting }) => {
    try {
      ...
      showModal(
        "",
        `Admin's Meeting Document added successfully!`,
        () => navigate(-1),
        true
      );
                              ...
                              <div className="d-flex align-items-center gap-3 mb-4 mb-sm-3 flex-wrap">
                                <FormCheck
                                  ...
                                  onChange={(e) => {
                                    ...
                                    setFieldTouched("sessionTypes.quick", true);
                                  }}
                                />
                                ...
                                <Field
                                  ...
                                  className="form-control w-auto"
                                  disabled={
                                    !values.sessionTypes?.quick?.includes(value)
                                  }
                                  placeholder="Enter Amount"
                                  min={0}
                                  max={100}
...
export default withModal(ConsultantMeetingDocument);
