        ...
        <Row>
          <Col xs={12}>
            <div className="dashCard">
              <Row>
                <Col xs={12} className="d-flex mb-4 mb-xl-5">
                  <BackButton2 />
              ...
              <Row>
                <Col xs={12}>
                  <Row>
                    <Col xs={12}>
                      <div className="d-flex flex-column flex-md-row align-items-center mb-3 mt-3">
                        <div className="user-avater">
                          <img
                            src={
                              consultantData?.userImage ?? images.placeholder
                            }
                            alt="User"
